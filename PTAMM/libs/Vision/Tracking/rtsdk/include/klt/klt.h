...
/************************************************************************/
/* added by dzl, on 2009. 12.16                                         */
void KLTTrackFeatures_float(
					  KLT_TrackingContext tc,
					  _KLT_Pyramid pyr2, 
					  _KLT_Pyramid pyr2_gradx,
					  _KLT_Pyramid pyr2_grady,
					  int ncols,
					  int nrows,
					  KLT_FeatureList featurelist);

void KLTTrackFeatures_one(
							KLT_TrackingContext tc,
							_KLT_Pyramid pyr2, 
							_KLT_Pyramid pyr2_gradx,
							_KLT_Pyramid pyr2_grady,
...
void KLTTrackFeatures_once(
						  KLT_TrackingContext tc,
						  _KLT_Pyramid pyr1, 
						  _KLT_Pyramid pyr1_gradx,
						  _KLT_Pyramid pyr1_grady,
						  _KLT_Pyramid pyr2, 
						  _KLT_Pyramid pyr2_gradx,
						  _KLT_Pyramid pyr2_grady,
						  int ncols,
