...
public class DefaultPageServlet extends HttpServlet {
    private static final String DEFAULT_ADMIN_PAGE = "/wonderland-web-runner";
    private static final String DEFAULT_USER_PAGE =
        ...
        throws ServletException, IOException
    {
        if (request.isUserInRole("admin")) {
            redirectTo(response, DEFAULT_ADMIN_PAGE);
        } else {
            redirectTo(response, DEFAULT_USER_PAGE);
        }
    } 
