...
/**
 * Message requesting the location of a particular cell
 * @author Jonathan Kaplan <kaplanj@dev.java.net>
 */
@ExperimentalAPI
public class CellLocationRequestMessage extends Message {
    private CellID requestCellID;

    public CellLocationRequestMessage(CellID requestCellID) {
