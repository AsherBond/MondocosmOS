...
/**
 * An insecure connection type
 * @author jkaplan
 */
public class SecurityCacheConnectionType extends ConnectionType {
    /** The server manager client type */
    public static final ConnectionType CONNECTION_TYPE =
            new SecurityCacheConnectionType();
    
    /** Use the static CLIENT_TYPE, not this constructor */
    public SecurityCacheConnectionType() {
        super ("__SecurityCacheConnection");
    }
}
