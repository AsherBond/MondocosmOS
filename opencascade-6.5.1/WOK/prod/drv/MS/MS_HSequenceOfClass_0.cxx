...
IMPLEMENT_STANDARD_TYPE(MS_HSequenceOfClass)
IMPLEMENT_STANDARD_SUPERTYPE_ARRAY()
  STANDARD_TYPE(MMgt_TShared),
  STANDARD_TYPE(Standard_Transient),

IMPLEMENT_STANDARD_SUPERTYPE_ARRAY_END()
IMPLEMENT_STANDARD_TYPE_END(MS_HSequenceOfClass)


IMPLEMENT_DOWNCAST(MS_HSequenceOfClass,Standard_Transient)
IMPLEMENT_STANDARD_RTTI(MS_HSequenceOfClass)
