...
#ifndef _WOKStep_ToolkitSource_HeaderFile
#define _WOKStep_ToolkitSource_HeaderFile
...
#endif
#ifndef _Handle_WOKStep_ToolkitSource_HeaderFile
#include <Handle_WOKStep_ToolkitSource.hxx>
#endif
...
//! Computes Toolkit Source File <br>
//!          List. <br>
class WOKStep_ToolkitSource : public WOKStep_Source {

public:

  
  Standard_EXPORT   WOKStep_ToolkitSource(const Handle(WOKMake_BuildProcess)& abp,const Handle(WOKernel_DevUnit)& aunit,const Handle(TCollection_HAsciiString)& acode,const Standard_Boolean checked,const Standard_Boolean hidden);




  DEFINE_STANDARD_RTTI(WOKStep_ToolkitSource)

protected:

  
  Standard_EXPORT     Handle_WOKernel_File GetPACKAGES() const;
  
  Standard_EXPORT     void AddPACKAGES(const Handle(WOKMake_InputFile)& unitcdl) ;
