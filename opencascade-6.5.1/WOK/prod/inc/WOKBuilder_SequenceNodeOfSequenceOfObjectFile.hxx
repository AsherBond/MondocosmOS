...
#define _WOKBuilder_SequenceNodeOfSequenceOfObjectFile_HeaderFile
...
class WOKBuilder_SequenceNodeOfSequenceOfObjectFile : public TCollection_SeqNode {

public:

  
      WOKBuilder_SequenceNodeOfSequenceOfObjectFile(const Handle(WOKBuilder_ObjectFile)& I,const TCollection_SeqNodePtr& n,const TCollection_SeqNodePtr& p);
  
        Handle_WOKBuilder_ObjectFile& Value() const;




  DEFINE_STANDARD_RTTI(WOKBuilder_SequenceNodeOfSequenceOfObjectFile)
...
Handle_WOKBuilder_ObjectFile myValue;
