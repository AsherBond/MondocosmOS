...
#define _WOKMake_DepItemHasher_HeaderFile
...
//! Default ::HashCode(K,Upper) <br>
  Standard_EXPORT   static  Standard_Integer HashCode(const Handle(WOKMake_DepItem)& Key) ;
...
//! Default K1 == K2 <br>
  Standard_EXPORT   static  Standard_Boolean IsEqual(const Handle(WOKMake_DepItem)& K1,const Handle(WOKMake_DepItem)& K2) ;
