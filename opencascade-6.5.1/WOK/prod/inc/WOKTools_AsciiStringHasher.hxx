...
#ifndef _WOKTools_AsciiStringHasher_HeaderFile
#define _WOKTools_AsciiStringHasher_HeaderFile
...
class WOKTools_AsciiStringHasher  {
public:
...
//! Default ::HashCode(K,Upper) <br>
  Standard_EXPORT   static  Standard_Integer HashCode(const TCollection_AsciiString& Key) ;
