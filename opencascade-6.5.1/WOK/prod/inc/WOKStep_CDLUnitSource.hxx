...
#define _WOKStep_CDLUnitSource_HeaderFile
...
class WOKStep_CDLUnitSource : public WOKStep_Source {

public:

  
  Standard_EXPORT   WOKStep_CDLUnitSource(const Handle(WOKMake_BuildProcess)& abp,const Handle(WOKernel_DevUnit)& aunit,const Handle(TCollection_HAsciiString)& acode,const Standard_Boolean checked,const Standard_Boolean hidden);




  DEFINE_STANDARD_RTTI(WOKStep_CDLUnitSource)
