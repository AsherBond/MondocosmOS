...
#ifndef _WOKUnix_CantBlockBuffer_HeaderFile
#define _WOKUnix_CantBlockBuffer_HeaderFile
...
#endif
#ifndef _Handle_WOKUnix_CantBlockBuffer_HeaderFile
#include <Handle_WOKUnix_CantBlockBuffer.hxx>
#endif
...
class WOKUnix_CantBlockBuffer : public WOKUnix_Buffer {

public:

  
  Standard_EXPORT   WOKUnix_CantBlockBuffer(const WOKUnix_FDescr& afd,const WOKUnix_BufferIs astd);
  ...
  DEFINE_STANDARD_RTTI(WOKUnix_CantBlockBuffer)
