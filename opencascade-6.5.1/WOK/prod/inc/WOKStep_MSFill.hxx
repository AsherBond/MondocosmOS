...
#ifndef _WOKStep_MSFill_HeaderFile
#define _WOKStep_MSFill_HeaderFile
...
#include <Handle_WOKStep_MSFill.hxx>
#endif
...
class WOKStep_MSFill : public WOKStep_MSStep {

public:

  
  Standard_EXPORT   WOKStep_MSFill(const Handle(WOKMake_BuildProcess)& abp,const Handle(WOKernel_DevUnit)& aunit,const Handle(TCollection_HAsciiString)& acode,const Standard_Boolean checked,const Standard_Boolean hidden);




  DEFINE_STANDARD_RTTI(WOKStep_MSFill)
