...
#ifndef _WOKStep_ClientExtract_HeaderFile
#define _WOKStep_ClientExtract_HeaderFile
...
#include <Handle_WOKStep_ClientExtract.hxx>
#endif
...
class WOKStep_ClientExtract : public WOKStep_Extract {

public:

  
  Standard_EXPORT   WOKStep_ClientExtract(const Handle(WOKMake_BuildProcess)& abp,const Handle(WOKernel_DevUnit)& aunit,const Handle(TCollection_HAsciiString)& acode,const Standard_Boolean checked,const Standard_Boolean hidden);
  
  Standard_EXPORT     Standard_Boolean HandleInputFile(const Handle(WOKMake_InputFile)& infile) ;
  ...
  DEFINE_STANDARD_RTTI(WOKStep_ClientExtract)
